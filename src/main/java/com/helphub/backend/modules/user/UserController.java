...
public class UserController {
        ...
        public ApiResponse<UserDetailResponse> getUserById(@PathVariable @NotNull UUID id) {
                UserDetailResponse response = userService
                                .getUserById(Objects.requireNonNull(id, "User ID must not be null"));
        ...
        public ApiResponse<UserDetailResponse> updateUserRole(
                        ...
                        @AuthenticationPrincipal CustomUserDetails currentUser) {
                UserDetailResponse response = userService.updateUserRole(
                                Objects.requireNonNull(id, "User ID must not be null"), request,
        ...
        public ApiResponse<UserDetailResponse> updateUserStatus(
                        ...
                        @AuthenticationPrincipal CustomUserDetails currentUser) {
                UserDetailResponse response = userService.updateUserStatus(
                                Objects.requireNonNull(id, "User ID must not be null"), request,
                                currentUser.getUserId());
                return ApiResponse.<UserDetailResponse>builder()
                                .success(true)
